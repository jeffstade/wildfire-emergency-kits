...
The `getServedTractsPlot()` function uses the dataframe from `getPrioritizedCensusTracts()` to generate a map of the tracts that can be served.
...
In short, we believe that this is just the beginning. We hope our CalKit application and its open source framework can help communities make data-informed decisions when preparing for - and responding to - both emergency disasters and everyday problems.
